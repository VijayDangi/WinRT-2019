...
{
	// MessageBox(NULL, TEXT("IN => CRecordFile(void)"), TEXT("INFO"), MB_OK);

	m_cRef = 1;
	InterlockedIncrement(&glNumberOfActiveComponents);
	
	// MessageBox(NULL, TEXT("OUT => CRecordFile(void)"), TEXT("INFO"), MB_OK);
}
...
{
	// MessageBox(NULL, TEXT("IN => CRecordFile::QueryInterface"), TEXT("INFO"), MB_OK);
	...
	// MessageBox(NULL, TEXT("OUT => CRecordFile::QueryInterface"), TEXT("INFO"), MB_OK);
...
{
	// MessageBox(NULL, TEXT("IN => CRecordFile::AddRef"), TEXT("INFO"), MB_OK);
	
	InterlockedIncrement(&m_cRef);
	
	// MessageBox(NULL, TEXT("OUT => CRecordFile::AddRef"), TEXT("INFO"), MB_OK);
	return(m_cRef);
}
///////////////////////////////////////////////
ULONG CRecordFile::Release(void)
{
	// MessageBox(NULL, TEXT("IN => CRecordFile::Release"), TEXT("INFO"), MB_OK);
	
	InterlockedDecrement(&m_cRef);
	if(m_cRef == 0)
	{
		delete(this);
		// MessageBox(NULL, TEXT("OUT => CRecordFile::Release"), TEXT("INFO"), MB_OK);
		return(0);
	}
	// MessageBox(NULL, TEXT("OUT => CRecordFile::Release"), TEXT("INFO"), MB_OK);
	return(m_cRef);
...
{
	// MessageBox(NULL, TEXT("IN => CRecordFile::SearchRecordInFile"), TEXT("INFO"), MB_OK);
	(*recordLength) = 0;
	////printf("+++++++++++++++++ SEARCH ==> %s ++++++++++++++++++++++++\n", departmentName);
	...
	// MessageBox(NULL, TEXT("OUT => CRecordFile::SearchRecordInFile"), TEXT("INFO"), MB_OK);
...
{
	// MessageBox(NULL, TEXT("IN => CRecordFile::SearchRecordInAllFile"), TEXT("INFO"), MB_OK);
	...
	*recordLength = 0;
	...
	//the following name is taken from file "AstroMediComp_Index.dat"
	//WM_CREATE
	...
	*recordLength += tempraryRecordLength;
	...
	// MessageBox(NULL, TEXT("OUT => CRecordFile::SearchRecordInAllFile"), TEXT("INFO"), MB_OK);
...
{
	// MessageBox(NULL, TEXT("IN => CRecordFile::ReadRecordFromFile"), TEXT("INFO"), MB_OK);
	(*recordLength) = 0;
	////printf("LINE : %d\n", __LINE__);
	////printf("+++++++++++++++++ %s ++++++++++++++++++++++++\n", departmentName);
	struct EmployeeDetails *tempraryPointer = NULL;
	...
	// MessageBox(NULL, TEXT("OUT => CRecordFile::ReadRecordFromFile"), TEXT("INFO"), MB_OK);
...
{
	// MessageBox(NULL, TEXT("IN => CRecordFile::ReadRecordFromAllFile"), TEXT("INFO"), MB_OK);
	struct EmployeeDetails *tempraryPointer = NULL;
	int tempraryRecordLength = 0;
	*employeeRecordArray = NULL;
	*recordLength = 0;
	...
	*recordLength += tempraryRecordLength;
	...
	// MessageBox(NULL, TEXT("OUT => CRecordFile::ReadRecordFromAllFile"), TEXT("INFO"), MB_OK);
	//printf("======================================================\n");
	//printf("======================================================\n");
	//printf("======================================================\n");
	return(hr);
...
{
	// MessageBox(NULL, TEXT("IN => CRecordFile::ReadRecord"), TEXT("INFO"), MB_OK);
	HRESULT hr;
	...
	// MessageBox(NULL, TEXT("OUT => CRecordFile::ReadRecord"), TEXT("INFO"), MB_OK);
...
{		
	...
	char EmployeeIDFile[] = "EmployeeFile.dat";
	...
	strcpy(FileName, departmentName);
	strcpy(IndexFileName, departmentName);
...
{
	// MessageBox(NULL, TEXT("IN => CRecordFileClassFactory::CRecordFileClassFactory"), TEXT("INFO"), MB_OK);
	m_cRef = 1;
	// MessageBox(NULL, TEXT("OUT => CRecordFileClassFactory::CRecordFileClassFactory"), TEXT("INFO"), MB_OK);
}
...
{
	// MessageBox(NULL, TEXT("IN => CRecordFileClassFactory::QueryInterface"), TEXT("INFO"), MB_OK);
	if(riid == IID_IUnknown)
	...
	{
		*ppv = NULL;
		// MessageBox(NULL, TEXT("OUT => CRecordFileClassFactory::QueryInterface"), TEXT("INFO"), MB_OK);
		return(E_NOINTERFACE);
	}
	reinterpret_cast<IUnknown *>(*ppv)->AddRef();
	// MessageBox(NULL, TEXT("OUT => CRecordFileClassFactory::QueryInterface"), TEXT("INFO"), MB_OK);
...
{
	// MessageBox(NULL, TEXT("IN => CRecordFileClassFactory::AddRef"), TEXT("INFO"), MB_OK);
	InterlockedIncrement(&m_cRef);
	// MessageBox(NULL, TEXT("OUT => CRecordFileClassFactory::AddRef"), TEXT("INFO"), MB_OK);
	return(m_cRef);
}

ULONG CRecordFileClassFactory::Release(void)
{
	// MessageBox(NULL, TEXT("IN => CRecordFileClassFactory::Release"), TEXT("INFO"), MB_OK);
	InterlockedDecrement(&m_cRef);
	if(m_cRef == 0)
	{
		delete(this);
		// MessageBox(NULL, TEXT("OUT => CRecordFileClassFactory::Release"), TEXT("INFO"), MB_OK);
		return(0);
	}
	// MessageBox(NULL, TEXT("OUT => CRecordFileClassFactory::Release"), TEXT("INFO"), MB_OK);
	return(m_cRef);
...
{
	///************************///
	// MessageBox(NULL, TEXT("IN => CRecordFileClassFactory::CreateInstance"), TEXT("INFO"), MB_OK);
	FILE *fp = fopen("AstroMediComp_Index.dat","r");
	if(fp)
	{
		fclose(fp);  //files are created
	}
	else
	{
		createFilesIfNotExist(); //files are not created and create the files first
	}
