#ifndef __AMC_SERVER_H__
#define __AMC_SERVER_H__
...
//Department name
extern const __declspec(selectany) char* Department_WM_CREATE      = "WM_CREATE";
extern const __declspec(selectany) char* Department_WM_LBUTTONDOWN = "WM_LBUTTONDOWN";
extern const __declspec(selectany) char* Department_WM_SIZE        = "WM_SIZE";
extern const __declspec(selectany) char* Department_WM_KEYUP       = "WM_KEYUP";
extern const __declspec(selectany) char* Department_WM_KEYDOWN     = "WM_KEYDOWN";
extern const __declspec(selectany) char* Department_WM_COMMAND     = "WM_COMMAND";
extern const __declspec(selectany) char* Department_WM_DRAWITEM    = "WM_DRAWITEM";
extern const __declspec(selectany) char* Department_WM_PAINT       = "WM_PAINT";
extern const __declspec(selectany) char* Department_WM_CHAR        = "WM_CHAR";
extern const __declspec(selectany) char* Department_WM_DESTROY     = "WM_DESTROY";
extern const __declspec(selectany) char* Department_WM_SETFOCUS    = "WM_SETFOCUS";
extern const __declspec(selectany) char* Department_WM_ENABLE      = "WM_ENABLE";
extern const __declspec(selectany) char* Department_WM_MOUSEMOVE   = "WM_MOUSEMOVE";
extern const __declspec(selectany) char* Department_WM_RBUTTONDOWN = "WM_RBUTTONDOWN";
